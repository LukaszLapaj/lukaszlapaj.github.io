...
export const Header = () => (
    <>
        <div>
            <img className="img-fluid mx-auto d-block not-draggable rounded-circle profile-image" loading="eager" width="398" height="398" alt="" src="https://avatars0.githubusercontent.com/u/4143729?s=500"/>
        </div>
        <div>
